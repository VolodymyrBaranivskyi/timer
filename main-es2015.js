...
let CountdownComponent = class CountdownComponent {
    ...
    start() {
        ...
        this.timerOnGoing = this.timer$
            ...
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["takeWhile"])(data => this.isTimerStopped(this.currentTime)))
    ...
    wait() {
        ...
        const doubleClick = this.clicks$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["throttleTime"])(300, rxjs__WEBPACK_IMPORTED_MODULE_2__["asyncScheduler"], throttleConfig));
